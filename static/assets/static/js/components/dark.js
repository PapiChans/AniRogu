...
function initTheme() {
  ...
  // Modified Code for Dark Theme Only (Start)
  // If there's no stored theme, or if stored theme is not "light", default to dark theme
  if (!storedTheme || storedTheme === "dark") {
    return setTheme("dark", true); // Setting dark theme and persisting it
  }

  // If stored theme is "light", set the light theme
  setTheme("light", true);
  // Modified Code for Dark Theme Only (End)
